...
describe('Application launch', function () {
  ...
  it('opens a window', function () {
    return Promise.all([
      ...
      this.app.client.browserWindow.getBounds().should.eventually.have.property('width').and.be.above(0),
      this.app.client.browserWindow.getBounds().should.eventually.have.property('height').and.be.above(0)
    ])
  })
})
