    ...
    <el-header height="auto">
      <el-card>
        <el-form ref="form" :model="formModel" inline>
          ...
          <el-form-item label="标签分类：" prop="appId">
            <el-input v-model.trim="formModel.appId" placeholder="请输入标签分类" />
          </el-form-item>

          <el-form-item label="正则表达式：" prop="isActive">
            <el-input v-model.trim="formModel.isActive" placeholder="请输入原生正则" />
          </el-form-item>
